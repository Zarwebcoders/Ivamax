    ...
    try {
        ...
        res.json({
            ...
            data: {
                ...
                pmrIncome: parseFloat(pmrIncome.toFixed(2)),
                drrIncome: parseFloat(drrIncome.toFixed(2)),
                fcrIncome: parseFloat(fcrIncome.toFixed(2)),
                dfrIncome: parseFloat(dfrIncome.toFixed(2)),
                // Current month incomes
                currentMonthIncome: parseFloat(currentTotal.toFixed(2)),
                currentPMR: parseFloat(currentPMR.toFixed(2)),
                currentDRR: parseFloat(currentDRR.toFixed(2)),
                currentFCR: parseFloat(currentFCR.toFixed(2)),
                currentDFR: parseFloat(currentDFR.toFixed(2)),
                // Percentage changes
