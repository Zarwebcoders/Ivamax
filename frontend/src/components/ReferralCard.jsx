                    ...
                    <div className="flex items-center justify-center gap-3 md:gap-8 mb-6 md:mb-12">
                        ...
                        <div className="flex flex-col items-center gap-2 md:gap-3">
                            <button
                                ...
                                className={`px-3 md:px-8 py-2 md:py-3 rounded-xl font-bold text-xs md:text-sm uppercase tracking-wide transition-all shadow-md w-28 md:w-40 relative ${activeRefTab === 'left'
                            ...
                            >
                                ...
                                {stats.isLeftDirectFilled && (
                                    <span className="absolute -top-2 -right-2 bg-red-500 text-white text-[8px] font-bold px-1.5 py-0.5 rounded-full uppercase shadow-sm">Filled</span>
                                )}
                            </button>
                            <button
                        ...
                        <div className="flex flex-col items-center gap-2 md:gap-3">
                            <button
                                ...
                                className={`px-3 md:px-8 py-2 md:py-3 rounded-xl font-bold text-xs md:text-sm uppercase tracking-wide transition-all shadow-md w-28 md:w-40 relative ${activeRefTab === 'right'
                                    ? 'bg-amber-500 text-white shadow-amber-500/30 ring-4 ring-amber-500/20 transform scale-105'
                                    : 'bg-white border border-gray-200 text-gray-500 hover:bg-gray-50'
                                    }`}
                            >
                    ...
                    <div className="space-y-1 md:space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                            <button
                                ...
                                className="bg-[#25D366] text-white py-3 rounded-xl font-bold uppercase text-xs md:text-sm shadow-md hover:shadow-lg hover:bg-[#20bd5a] transition-all flex items-center justify-center gap-2 active:scale-95 group"
                            >
                            ...
                            <button
                                ...
                                className="bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] text-white py-3 rounded-xl font-bold uppercase text-xs md:text-sm shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 active:scale-95 group"
                            >
                            ...
                            <button
                                ...
                                className="bg-[#0088cc] text-white py-3 rounded-xl font-bold uppercase text-xs md:text-sm shadow-md hover:shadow-lg hover:bg-[#0077b5] transition-all flex items-center justify-center gap-2 active:scale-95 group"
                            >
